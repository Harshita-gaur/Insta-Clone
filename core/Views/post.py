...
from core.models import Post, PostComment, PostLike, User, UserFollow
from core.serializer import CommentSerializer, PostLikeSerializer, PostSerializer, UserFollowSerializer
